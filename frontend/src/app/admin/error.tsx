  ...
  return (
    <main className="min-h-screen bg-ink px-4 py-8 text-white">
      <section className="mx-auto max-w-md rounded-lg border border-line bg-surface p-4">
        <h1 className="text-xl font-semibold">Business tools could not load</h1>
        <p className="mt-2 text-sm leading-6 text-zinc-400">Your club data is still safe. Try again with an owner or admin account.</p>
