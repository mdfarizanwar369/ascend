...
export function AppleSubscriptionClient() {
  ...
  return <main className="min-h-screen bg-ink px-4 py-5 text-white"><div className="mx-auto max-w-2xl">
    ...
    <div className="mt-4 flex gap-5 text-sm text-calm"><Link href="/privacy">Privacy Policy</Link><a href="https://www.apple.com/legal/internet-services/itunes/dev/stdeula/">Terms of Use</a></div>
  </div></main>;
}
