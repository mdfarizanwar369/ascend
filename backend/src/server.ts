...
import { appleSubscriptionsRouter } from "./routes/appleSubscriptions";
...
app.use("/api/v1", aiConsentRouter);
...
app.use("/api/v1", trainerHomeworkRouter);
app.use("/api/v1", trainerSessionsRouter);
app.use("/api/v1", adminRouter);
app.use("/api/v1", aiRouter);
app.use("/api/v1", subscriptionsRouter);
app.use("/api/v1", appleSubscriptionsRouter);
