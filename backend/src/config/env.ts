...
const schema = z.object({
  ...
  AI_STAGING_DAILY_FOOD_ANALYSIS_LIMIT: z.coerce.number().int().positive().default(50),
  AI_STAGING_DAILY_FOOD_ANALYSIS_PER_USER_LIMIT: z.coerce.number().int().positive().default(10),
  AI_STAGING_MONTHLY_FOOD_ANALYSIS_LIMIT: z.coerce.number().int().positive().default(500),
