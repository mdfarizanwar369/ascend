...
export type AiEventType = "food_image_analysis" | "ai_chat_message" | "weekly_report_generation" | "memory_reflection" | "workout_capture_analysis" | "trainer_session_delta_analysis";
...
const eventCostCents: Record<AiEventType, number> = {
  ...
  trainer_session_delta_analysis: env.AI_CHAT_ESTIMATED_COST_CENTS
};
