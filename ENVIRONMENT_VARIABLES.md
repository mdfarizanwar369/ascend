...
| `COACH_ZOE_WORKOUT_DEBRIEF_V1` | No | `false` | Enables post-workout Coach Zoe debriefs for eligible member workout sources. |
| `COACH_ZOE_WORKOUT_DEBRIEF_OWNER_PILOT` | No | `false` | Enables post-workout debriefs only for the platform owner while the global flag is off. |
